...
JWKGen.initialize = async (options) => {
    var _b;
...
function jwkgen(imports){return _loadWasmModule(0, '../jwkgen_bg.wasm', null, imports)}

// @ts-ignore
setWasmInit(() => jwkgen());

exports.JWKGen = JWKGen;
